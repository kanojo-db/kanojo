...
use App\Transformers\StudioIDTransformer;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use League\Fractal\Pagination\IlluminatePaginatorAdapter;

class ChangesStudioController extends Controller
{
    /**
     * Studios
     *
     * Get a list of all studio IDs updated in the given time range. Defaults to the last 24 hours.
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->json(
            fractal()
                ...
                ->transformWith(new StudioIDTransformer())
