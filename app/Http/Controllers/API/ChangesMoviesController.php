...
use App\Transformers\MovieIDTransformer;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use League\Fractal\Pagination\IlluminatePaginatorAdapter;

class ChangesMoviesController extends Controller
{
    /**
     * Movies
     *
     * Get a list of all movie IDs updated in the given time range. Defaults to the last 24 hours.
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->json(
            fractal()
                ...
                ->transformWith(new MovieIDTransformer())
