...
use App\Transformers\PersonIDTransformer;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use League\Fractal\Pagination\IlluminatePaginatorAdapter;

class ChangesPeopleController extends Controller
{
    /**
     * People
     *
     * Get a list of all person IDs updated in the given time range. Defaults to the last 24 hours.
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->json(
            fractal()
                ...
                ->transformWith(new PersonIDTransformer())
