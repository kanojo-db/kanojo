...
class SettingsSessionsController extends Controller
{
     ...
     *
     * @return \Illuminate\Support\Collection<array-key, array{id: mixed, platform: bool|string, browser: bool|string, ip_address: mixed, is_current_device: bool, last_active: string}>
     */
    public function sessions(Request $request): Collection
    {
        ...
        /** @var array<array-key, object{id: mixed, user_id: mixed, ip_address: mixed, user_agent: mixed, payload: mixed, last_activity: mixed}> */
