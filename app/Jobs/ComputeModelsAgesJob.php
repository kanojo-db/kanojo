...
class ComputeModelsAgesJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        if ($this->movie->release_date === null) {
            $this->movie->models()->updateExistingPivot($this->movie->models->pluck('id'), ['age' => null], false);
        ...
        foreach ($this->movie->models as $model) {
            ...
            if ($model->birthdate === null) {
                $this->movie->models()->updateExistingPivot($model->id, ['age' => null], false);
            ...
            $this->movie->models()->updateExistingPivot($model->id, ['age' => $age], false);
        }
    }
}
